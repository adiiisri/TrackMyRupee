...
import { ArrowRight, TrendingUp, Shield, BarChart3, Target, Sparkles, CheckCircle2, Sparkle, CircleDollarSign } from 'lucide-react';
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.875rem', color: '#6b7280', margin: 0 }}>
            © {new Date().getFullYear()} TrackMyRupee Personal Wealth. Built for modern financial mindfulness.
          </p>
        </div>
      </footer>
    </div>
